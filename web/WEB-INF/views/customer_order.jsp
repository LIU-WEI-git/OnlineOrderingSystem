                    ...
                    <c:forEach items="${orders}" var="order">
                        <ul class="product_img">
                            <li class="product_right">
                                ...
                                <a href="<c:url value="/order_item?order_id=${order.order_id}"/>"><h4 style="color:blue"><strong>订单详情</strong></h4></a>
                                ...
                                <div class="but1">
                                    <a href="<c:url value="/address_info?order_id=${order.order_id}" />"><h4 style="color:blue">订单地址详情</h4></a>
                                </div>
