                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav menu1">
                                ...
                                <li class="active"><a href="admin_fruits.jsp">Fruits & Veg</a></li>
                                <li><a href="admin_products.jsp">Food Products</a></li>
                            ...
                            <div class="col-md-3">
                                <div class="content_box"><a href="single.jsp">
                                    <div class="view view-fifth">
                                        <img src="${pageContext.request.contextPath}/resources/${dish.picture_url}" class="img-responsive" alt="">
                                        <div class="content_box-grid">
                                            <p class="m_1">
                                                <c:out value="${dish.dish_name}" />
                                            </p>
                                            <div class="price">Price:
                                                <span class="actual">$${dish.price}</span>
                                            </div>
