...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <form action="<c:url value="/admin/categorychange"/>">
                <p>菜品编号${category.getCategory_id()}</p>
                菜品类名称：<input type="text"  name="name" value="${category.getCategory_name()}"  required/><br/><br/>
