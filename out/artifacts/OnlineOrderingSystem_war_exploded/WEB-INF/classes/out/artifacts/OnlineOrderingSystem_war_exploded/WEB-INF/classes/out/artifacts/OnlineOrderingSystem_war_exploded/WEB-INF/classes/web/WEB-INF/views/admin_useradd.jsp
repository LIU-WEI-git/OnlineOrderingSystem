...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <sf:form method="POST" commandName="admin">
                <sf:errors path="*"  cssClass="error"/><br/><br/>
                　　  账户：<sf:input type="text" path="admin_account" minlength="2" maxlength="6"/><%--<sf:errors path="admin_account" cssClass="error"/>--%><br/><br/>
                　　  姓名：<sf:input type="text" path="admin_name" minlength="2" maxlength="4"/><%--<sf:errors path="admin_name" cssClass="error"/>--%><br/><br/>
                　   密码：<sf:password  path="admin_password" /><%--<sf:errors path="admin_password" cssClass="error"/> --%> <br/><br/>
                     邮箱：<sf:input path="admin_email"  type="email"/><%--<sf:errors path="admin_email" cssClass="error"/>--%><br/><br/>
                　   电话：<sf:input  type="text" path="admin_phone" minlength="2" maxlength="4"/><%--<sf:errors path="admin_phone" cssClass="error"/>--%><br/><br/>
                     <sf:input  type="hidden" path="delete_tag" /><sf:errors path="delete_tag" cssClass="error"/><br/><br/>
